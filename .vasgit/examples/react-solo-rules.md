...
```
fix: correct component rendering
fix: resolve prop type warning
...
```
feat!: upgrade to React 19 (breaking)
refactor!: change component API (breaking)
```
